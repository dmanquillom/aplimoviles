...
public class SetupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usersRef = FirebaseDatabase.getInstance().getReference().child(getString(R.string.dbTeachers)).child(currentUserId);
        ...
        userAddress = (EditText) findViewById(R.id.setup_address);
