...
import co.unal.myexperience.Model.Message;
import co.unal.myexperience.Model.MessageAdapter;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            chatReceiverName.setText(lesson.getTeacherName());
            Picasso.get().load(lesson.getTeacherImage()).into(chatReceiverProfileImage);
        }
        ...
        messagesRef.child(lesson.getStudentId()).child(lesson.getTeacherId()).addValueEventListener(new ValueEventListener() {
            @Override
        ...
        switch (view.getId()) {
            case R.id.chat_send_message_button:
                ...
                if(!TextUtils.isEmpty(chatMessage)){
                    ...
                    message.setId(lesson.getStudentId());
                    message.setImage(lesson.getStudentImage());
